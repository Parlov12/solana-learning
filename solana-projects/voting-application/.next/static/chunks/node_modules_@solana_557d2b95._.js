...
function isTransactionMessageWithBlockhashLifetime(transactionMessage) {
    ...
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$rpc$2d$types$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertIsBlockhash"])(transactionMessage.lifetimeConstraint.blockhash);
        return true;
    } catch  {
        return false;
    }
...
function compressTransactionMessageUsingAddressLookupTables(transactionMessage, addressesByLookupTableAddress) {
    ...
    for (const instruction of transactionMessage.instructions){
        ...
        for (const account of instruction.accounts){
            if ("lookupTableAddress" in account || !lookupTableAddresses.has(account.address) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$instructions$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSignerRole"])(account.role)) {
...
async function signTransactionMessageWithSigners(transactionMessage, config) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transactions$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertTransactionIsFullySigned"])(signedTransaction);
...
function createRecentSignatureConfirmationPromiseFactory({ rpc, rpcSubscriptions }) {
    return async function getRecentSignatureConfirmationPromise({ abortSignal: callerAbortSignal, commitment, signature }) {
        ...
        const signatureStatusLookupPromise = (async ()=>{
            ...
            if (signatureStatus && signatureStatus.confirmationStatus && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$rpc$2d$types$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["commitmentComparator"])(signatureStatus.confirmationStatus, commitment) >= 0) {
                return;
            } else {
                await new Promise(()=>{});
            }
...
function createComputeUnitLimitInstruction(units) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$codecs$2d$numbers$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getU32Encoder"])().write(units, data, 1);
    return Object.freeze({
        data,
...
async function getComputeUnitEstimateForTransactionMessage_INTERNAL_ONLY_DO_NOT_EXPORT({ abortSignal, rpc, transactionMessage, ...simulateConfig }) {
    const isDurableNonceTransactionMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transaction$2d$messages$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isDurableNonceTransaction"])(transactionMessage);
    let compilableTransactionMessage;
    if (isDurableNonceTransactionMessage || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transaction$2d$messages$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isTransactionMessageWithBlockhashLifetime"])(transactionMessage)) {
    ...
    const compiledTransaction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transactions$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["compileTransaction"])(compilableTransactionMessage);
    const wireTransactionBytes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transactions$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBase64EncodedWireTransaction"])(compiledTransaction);
    try {
...
function useSignAndSendTransactions(uiWalletAccount, chain) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSignAndSendTransactions.useCallback": async (...inputs)=>{
            const inputsWithChainAndAccount = inputs.map({
                "useSignAndSendTransactions.useCallback.inputsWithChainAndAccount": ({ options, ...rest })=>{
...
function useSignIns(uiWalletHandle) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSignIns.useCallback": async (...inputs)=>{
            ...
            const resultsWithoutSignatureType = results.map({
                "useSignIns.useCallback.resultsWithoutSignatureType": ({ account, signatureType: _, // Solana signatures are always of type `ed25519` so drop this property.
                ...rest })=>({
                        ...rest,
...
function useSignMessages(uiWalletAccount) {
    ...
    const account = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wallet$2d$standard$2f$ui$2d$registry$2f$lib$2f$esm$2f$UiWalletHandleRegistry_DO_NOT_USE_OR_YOU_WILL_BE_FIRED$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWalletAccountForUiWalletAccount_DO_NOT_USE_OR_YOU_WILL_BE_FIRED"])(uiWalletAccount);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSignMessages.useCallback": async (...inputs)=>{
            ...
            const resultsWithoutSignatureType = results.map({
                "useSignMessages.useCallback.resultsWithoutSignatureType": ({ signatureType: _, // Solana signatures are always of type `ed25519` so drop this property.
                ...rest })=>rest
...
function useSignTransactions(uiWalletAccount, chain) {
    ...
    const account = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wallet$2d$standard$2f$ui$2d$registry$2f$lib$2f$esm$2f$UiWalletHandleRegistry_DO_NOT_USE_OR_YOU_WILL_BE_FIRED$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWalletAccountForUiWalletAccount_DO_NOT_USE_OR_YOU_WILL_BE_FIRED"])(uiWalletAccount);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSignTransactions.useCallback": async (...inputs)=>{
            const inputsWithAccountAndChain = inputs.map({
                "useSignTransactions.useCallback.inputsWithAccountAndChain": ({ options, ...rest })=>{
                    const minContextSlot = options?.minContextSlot;
                    return {
                        ...rest,
                        account,
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useWalletAccountMessageSigner.useMemo": ()=>({
                ...
                async modifyAndSignMessages (messages, config) {
                    ...
                    const { signedMessage, signature } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$promises$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAbortablePromise"])(signMessage(input), config?.abortSignal);
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useWalletAccountTransactionSigner.useMemo": ()=>({
                ...
                async modifyAndSignTransactions (transactions, config = {}) {
                    ...
                    abortSignal?.throwIfAborted();
                    const transactionCodec = encoderRef.current ||= (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transactions$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTransactionCodec"])();
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useWalletAccountTransactionSendingSigner.useMemo": ()=>({
                ...
                async signAndSendTransactions (transactions, config = {}) {
                    const { abortSignal, ...options } = config;
                    abortSignal?.throwIfAborted();
                    const transactionEncoder = encoderRef.current ||= (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transactions$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTransactionEncoder"])();
                    if (transactions.length > 1) {
                        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$errors$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SolanaError"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$errors$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SOLANA_ERROR__SIGNER__WALLET_MULTISIGN_UNIMPLEMENTED"]);
                    }
                    if (transactions.length === 0) {
...
//# sourceMappingURL=node_modules_%40solana_557d2b95._.js.map