...
var getMinLogLevel = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.GILL_DEBUG_LEVEL || global.__GILL_DEBUG_LEVEL__ || typeof window !== "undefined" && window.__GILL_DEBUG_LEVEL__ || "info";
...
function checkedTransactionSigner(input) {
    if (typeof input === "string" || "address" in input == false) input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$signers$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNoopSigner"])(input);
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$signers$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isTransactionSigner"])(input)) throw new Error("A signer or address is required");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$signers$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertIsTransactionSigner"])(input);
    return input;
}
...
function createTransaction({ version, feePayer, instructions, latestBlockhash, computeUnitLimit, computeUnitPrice }) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$functional$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pipe"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transaction$2d$messages$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createTransactionMessage"])({
        ...
        if (latestBlockhash) {
            tx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transaction$2d$messages$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setTransactionMessageLifetimeUsingBlockhash"])(latestBlockhash, tx);
        }
        if (typeof feePayer !== "string" && "address" in feePayer && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$signers$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isTransactionSigner"])(feePayer)) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$signers$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setTransactionMessageFeePayerSigner"])(feePayer, tx);
        } else return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transaction$2d$messages$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setTransactionMessageFeePayer"])(feePayer, tx);
    }, (tx)=>{
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transaction$2d$messages$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["appendTransactionMessageInstructions"])(instructions, tx);
    });
}
function sendAndConfirmTransactionWithSignersFactory({ rpc, rpcSubscriptions }) {
    ...
    return async function sendAndConfirmTransactionWithSigners(transaction, config = {
        ...
        if ("messageBytes" in transaction == false) {
            transaction = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$signers$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signTransactionMessageWithSigners"])(transaction);
        }
        debug(`Sending transaction: ${getExplorerLink({
            transaction: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transactions$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSignatureFromTransaction"])(transaction)
        })}`);
        debug(`Transaction as base64: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transactions$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBase64EncodedWireTransaction"])(transaction)}`, "debug");
        await sendAndConfirmTransaction(transaction, config);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transactions$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSignatureFromTransaction"])(transaction);
    };
}
...
async function transactionToBase64WithSigners(tx) {
    ...
    else return transactionToBase64(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$signers$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["partiallySignTransactionMessageWithSigners"])(tx));
}
...
async function prepareTransaction(config) {
    ...
    if (computeBudgetIndex.limit < 0 || config.computeUnitLimitReset) {
        ...
        if (computeBudgetIndex.limit < 0) {
            config.transaction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transaction$2d$messages$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["appendTransactionMessageInstruction"])(ix, config.transaction);
    ...
    if (config.blockhashReset || "lifetimeConstraint" in config.transaction == false) {
        ...
        if ("lifetimeConstraint" in config.transaction == false) {
            ...
            config.transaction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transaction$2d$messages$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setTransactionMessageLifetimeUsingBlockhash"])(latestBlockhash, config.transaction);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transaction$2d$messages$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertIsTransactionMessageWithBlockhashLifetime"])(config.transaction);
    if (isDebugEnabled()) {
...
function simulateTransactionFactory({ rpc }) {
    return async function simulateTransaction(transaction, config) {
        if ("messageBytes" in transaction == false) {
            transaction = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$signers$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["partiallySignTransactionMessageWithSigners"])(transaction);
        }
        return rpc.simulateTransaction((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transactions$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBase64EncodedWireTransaction"])(transaction), {
...
async function generateExtractableKeyPairSigner() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$signers$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSignerFromKeyPair"])(await generateExtractableKeyPair());
}
...
async function createKeypairSignerFromBase58(punitiveSecretKey) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$signers$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSignerFromKeyPair"])(await createKeypairFromBase58(punitiveSecretKey));
}
...
"[project]/node_modules/gill/dist/chunk-NEQINEXL.node.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/gill/dist/chunk-DF5RIJC5.node.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/buffer/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$NEQINEXL$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gill/dist/chunk-NEQINEXL.node.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2d$program$2f$compute$2d$budget$2f$dist$2f$src$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@solana-program/compute-budget/dist/src/index.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$functional$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@solana/functional/dist/index.browser.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$transaction$2d$messages$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@solana/transaction-messages/dist/index.browser.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$signers$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@solana/signers/dist/index.browser.mjs [app-client] (ecmascript)");
...
async function prepareTransaction(config) {
    ...
    config.transaction.instructions.map((ix, index)=>{
        if (ix.programAddress != __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2d$program$2f$compute$2d$budget$2f$dist$2f$src$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COMPUTE_BUDGET_PROGRAM_ADDRESS"]) return;
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$NEQINEXL$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSetComputeLimitInstruction"])(ix)) {
            computeBudgetIndex.limit = index;
        }
    });
    if (computeBudgetIndex.limit < 0 || config.computeUnitLimitReset) {
...
"[project]/node_modules/gill/dist/chunk-S3U672XX.node.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function getCollectionCodec() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$codecs$2d$core$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["combineCodec"])(getCollectionEncoder(), getCollectionDecoder());
}
...
function getCollectionDetailsCodec() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$codecs$2d$core$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["combineCodec"])(getCollectionDetailsEncoder(), getCollectionDetailsDecoder());
}
...
function getCreatorCodec() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$codecs$2d$core$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["combineCodec"])(getCreatorEncoder(), getCreatorDecoder());
}
...
function getUsesCodec() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$codecs$2d$core$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["combineCodec"])(getUsesEncoder(), getUsesDecoder());
}
...
function getUseMethodEncoder() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$codecs$2d$data$2d$structures$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getEnumEncoder"])(UseMethod);
}
function getUseMethodDecoder() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$codecs$2d$data$2d$structures$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getEnumDecoder"])(UseMethod);
}
function getUseMethodCodec() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$codecs$2d$core$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["combineCodec"])(getUseMethodEncoder(), getUseMethodDecoder());
}
...
function getDataV2Codec() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$codecs$2d$core$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["combineCodec"])(getDataV2Encoder(), getDataV2Decoder());
}
...
function getCreateMetadataAccountV3DiscriminatorBytes() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$codecs$2d$numbers$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getU8Encoder"])().encode(CREATE_METADATA_ACCOUNT_V3_DISCRIMINATOR);
}
...
function getCreateMetadataAccountV3InstructionDataCodec() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$codecs$2d$core$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["combineCodec"])(getCreateMetadataAccountV3InstructionDataEncoder(), getCreateMetadataAccountV3InstructionDataDecoder());
}
...
async function getTokenMetadataAddress(mint) {
    return (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$addresses$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProgramDerivedAddress"])({
        ...
        seeds: [
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$addresses$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAddressEncoder"])().encode(TOKEN_METADATA_PROGRAM_ADDRESS),
...
"[project]/node_modules/gill/dist/programs/token/index.node.mjs [app-client] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$DF5RIJC5$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gill/dist/chunk-DF5RIJC5.node.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$S3U672XX$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gill/dist/chunk-S3U672XX.node.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$NEQINEXL$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/gill/dist/chunk-NEQINEXL.node.mjs [app-client] (ecmascript)");
...
async function getAssociatedTokenAccountAddress(mint, owner, tokenProgram) {
    return (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2d$program$2f$token$2d$2022$2f$dist$2f$src$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findAssociatedTokenPda"])({
        mint: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$NEQINEXL$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkedAddress"])(mint),
        owner: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$NEQINEXL$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkedAddress"])(owner),
        tokenProgram: checkedTokenProgramAddress(tokenProgram)
    }))[0];
}
function parseTokenProgramAddressOrMoniker(tokenProgram) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$addresses$2f$dist$2f$index$2e$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAddress"])(tokenProgram)) {
...
function getCreateTokenInstructions(args) {
    ...
    args.feePayer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$NEQINEXL$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkedTransactionSigner"])(args.feePayer);
    ...
    if (args.freezeAuthority) args.freezeAuthority = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$NEQINEXL$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkedAddress"])(args.freezeAuthority);
    if (args.tokenProgram === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2d$program$2f$token$2d$2022$2f$dist$2f$src$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TOKEN_2022_PROGRAM_ADDRESS"]) {
        ...
        return [
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2d$program$2f$system$2f$dist$2f$src$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCreateAccountInstruction"])({
                payer: args.feePayer,
                newAccount: args.mint,
                lamports: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$DF5RIJC5$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMinimumBalanceForRentExemption"])(space),
                space,
                programAddress: args.tokenProgram
            }),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2d$program$2f$token$2d$2022$2f$dist$2f$src$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getInitializeMintInstruction"])({
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$S3U672XX$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCreateMetadataAccountV3Instruction"])({
...
function getMintTokensInstructions(args) {
    args.tokenProgram = checkedTokenProgramAddress(args.tokenProgram);
    args.feePayer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$NEQINEXL$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkedTransactionSigner"])(args.feePayer);
    args.mint = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$NEQINEXL$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkedAddress"])(args.mint);
    return [
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2d$program$2f$token$2d$2022$2f$dist$2f$src$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCreateAssociatedTokenIdempotentInstruction"])({
            owner: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$NEQINEXL$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkedAddress"])(args.destination),
            mint: args.mint,
            ata: args.ata,
            payer: args.feePayer,
...
async function buildCreateTokenTransaction(args) {
    ...
    if (args.tokenProgram === TOKEN_PROGRAM_ADDRESS) {
        metadataAddress = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$S3U672XX$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTokenMetadataAddress"])(args.mint);
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$chunk$2d$DF5RIJC5$2e$node$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createTransaction"])((({ feePayer, version, computeUnitLimit, computeUnitPrice, latestBlockhash })=>({
            feePayer,
...
//# sourceMappingURL=node_modules_gill_dist_2e5146b7._.js.map