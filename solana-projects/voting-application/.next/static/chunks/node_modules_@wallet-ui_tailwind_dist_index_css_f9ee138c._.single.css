/* [project]/node_modules/@wallet-ui/tailwind/dist/index.css [app-client] (css) */
@layer properties {
...
@layer utilities {
  ...
  @supports (color: color-mix(in lab, red, red)) {
    .bg-neutral-100\/95 {
      background-color: color-mix(in oklab, var(--color-neutral-100) 95%, transparent);
    }
  }
...
:root, html.light:root, [data-theme="light"]:root {
...
[data-scope="dialog"][data-part="content"][data-state="open"] {
  animation: .3s ease-out anim-scale-in;
}

[data-scope="dialog"][data-part="content"][data-state="closed"] {
  animation: .2s ease-in anim-scale-out;
}
...
[data-ui="wallet-ui-list-button"]:disabled {
  cursor: not-allowed;
  opacity: .5;
}
...
/*# sourceMappingURL=node_modules_%40wallet-ui_tailwind_dist_index_css_f9ee138c._.single.css.map*/